...
import '../examples/do_nothing_tank.dart';
void main() {
  ...
  test('request_commands', () async {
    ...
    expect(response.statusCode, equals(200));
    expect(response.statusCode, isNot(400));
    expect(string, equals('[{"command_type":0,"arg":0}]'));
    expect(string, isNot('[]'));
  });
  ...
  test('request_commands_by_event', () async {
    ...
    expect(
      string,
      equals(
          '[{"command_type":0,"arg":0},[{"command_type":0,"arg":0},{"command_type":0,"arg":0}]]'),
    );
    expect(string, isNot('[]'));
    expect(string, isNot('[{"command_type":0,"arg":0}]'));
  });
